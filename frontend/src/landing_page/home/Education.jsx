    ...
    <div className="container mt-4 mt-md-5 px-3 px-md-5">
      <div className="row p-3 p-md-5 g-4 align-items-center">
        ...
        <div className="col-12 col-lg-6 order-1 order-lg-2 p-3 p-md-5 HomeTextBlocks">
          ...
          <a href="/" className="zerodha-link mx-2 my-3 d-inline-block">Varsity <i className="fa-solid fa-arrow-right"></i></a>
          ...
          <a href="/" className="zerodha-link mx-2">TradingQ&A <i className="fa-solid fa-arrow-right"></i></a>
        </div>
      </div>
    </div>
  )
